...
namespace BLL
{
    public class PDFManager
    {
        ...
        public bool createPDF(int tourid)
        {
            ...
            string docName = "C:\\Users\\omuel\\Desktop\\tourplanner\\Tour_" + tourid.ToString() + "_" + tour.Name + ".pdf";

            using (PdfWriter writer= new PdfWriter(docName))
                ...
                using(iText.Layout.Document document = new iText.Layout.Document(pdf))
            {
                ...
                list.Add("Estimated Time: " + tour.EstimatedTime + " hh:mm:ss");
                document.Add(list);
